...
function App() {
  ...
  function renderLiveStats() {
    ...
    // Desktop Site Card - Updated values for 17 journeys with 132 steps
    if (desktop) {
      cards.push(`
        <div class="detailed-stat-card desktop-border">
          ...
          <div class="card-content">
            ...
            <div class="steps-info">Test Steps: <span class="steps-value">132</span></div>
            <div class="success-info">Success Rate: <span class="success-value">100%</span></div>
            <div class="avg-time-info">Avg Step Time: <span class="time-value">0.053ms</span></div>
