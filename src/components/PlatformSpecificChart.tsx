...
const PlatformSpecificChart: React.FC<PlatformSpecificChartProps> = ({ platform }) => {
  ...
  const platformConfigs = {
    desktop: {
      ...
      passedCounts: [6, 12, 16, 12, 2, 6, 4],
      failedCounts: [7,12, 5, 14, 12, 18, 6],
      color: '#3b82f6'
    },
    mobile: {
      name: 'Mobile Site',
      // Feb 5-11: Passed and Failed data (Feb 11: -1 passed = 10)
      passedCounts: [5, 14, 12, 16, 12, 9, 8],
      failedCounts: [7, 8, 9, 8, 1, 14, 2],
      color: '#8b5cf6'
    },
    oms: {
      name: 'OMS',
   ...
   overall: {
      ...
      passedCounts: [15, 32, 34, 36, 19, 16],
      // Feb 5-11: Total Failed across all platforms (Feb 11: 1+3+0+0=4)
      failedCounts: [14, 20, 14, 22, 13, 8],
