...
const PlatformSpecificChart: React.FC<PlatformSpecificChartProps> = ({ platform }) => {
  ...
  const platformConfigs = {
    desktop: {
      ...
      passedCounts: [18, 19, 15, 21, 23, 19, 3],
      failedCounts: [6, 5, 9, 2, 3, 3, 0],
      color: '#3b82f6'
    },
    mobile: {
      name: 'Mobile Site',
      // Feb 5-11: Passed and Failed data (Feb 11: -1 passed = 10)
      passedCounts: [16, 21, 17, 18, 22, 20, 3],
      failedCounts: [8, 3, 7, 4, 2, 1, 0],
      color: '#8b5cf6'
    },
    oms: {
      name: 'OMS',
   ...
   overall: {
      ...
      passedCounts: [27, 42, 48, 40, 48, 43, 8],
      // Feb 5-11: Total Failed across all platforms (Feb 11: 1+3+0+0=4)
      failedCounts: [29, 14, 8, 16, 5, 2, 0],
