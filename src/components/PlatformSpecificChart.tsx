...
const PlatformSpecificChart: React.FC<PlatformSpecificChartProps> = ({ platform }) => {
  ...
  const platformConfigs = {
    desktop: {
      ...
      passedCounts: [10, 5, 6, 12, 16, 12, 2],
      failedCounts: [14, 13, 7,12, 5, 14, 12],
      color: '#3b82f6'
    },
    mobile: {
      name: 'Mobile Site',
      // Feb 5-11: Passed and Failed data (Feb 11: -1 passed = 10)
      passedCounts: [11, 6, 5, 14, 12, 16, 12],
      failedCounts: [13, 12, 7, 8, 9, 8, 1],
      color: '#8b5cf6'
    },
    oms: {
      name: 'OMS',
      // Feb 5-11: Passed and Failed data (Feb 7 has 1 failure, not 2)
      passedCounts: [4, 4, 4, 4, 4, 4, 2],
   ...
   overall: {
      ...
      passedCounts: [24, 17, 15, 32, 34, 36, 18],
      // Feb 5-11: Total Failed across all platforms (Feb 11: 1+3+0+0=4)
      failedCounts: [13, 25, 14, 20, 14, 22, 13],
