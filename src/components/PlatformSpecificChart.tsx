...
const PlatformSpecificChart: React.FC<PlatformSpecificChartProps> = ({ platform }) => {
  ...
  const platformConfigs = {
    desktop: {
      ...
      passedCounts: [13, 14, 10, 18, 19, 15, 16],
      failedCounts: [8, 5, 14, 6, 5, 9, 2],
      color: '#3b82f6'
    },
    mobile: {
      name: 'Mobile Site',
      // Feb 5-11: Passed and Failed data (Feb 11: -1 passed = 10)
      passedCounts: [14, 16, 11, 16, 21, 17, 16],
      failedCounts: [6, 7, 13, 8, 3, 7, 4],
      color: '#8b5cf6'
    },
    oms: {
      name: 'OMS',
      // Feb 5-11: Passed and Failed data (Feb 7 has 1 failure, not 2)
      passedCounts: [4, 4, 3, 4, 4, 4, 2],
    ...
    overall: {
      ...
      passedCounts: [35, 38, 27, 42, 48, 40, 36],
      // Feb 5-11: Total Failed across all platforms (Feb 11: 1+3+0+0=4)
      failedCounts: [14, 12, 29, 14, 8, 16, 7],
