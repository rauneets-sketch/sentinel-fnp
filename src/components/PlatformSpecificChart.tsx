...
const PlatformSpecificChart: React.FC<PlatformSpecificChartProps> = ({ platform }) => {
  ...
  const platformConfigs = {
    desktop: {
      ...
      passedCounts: [10, 18, 19, 15, 21, 23, 13],
      failedCounts: [14, 6, 5, 9, 2, 3, 1],
      color: '#3b82f6'
    },
    mobile: {
      name: 'Mobile Site',
      // Feb 5-11: Passed and Failed data (Feb 11: -1 passed = 10)
      passedCounts: [11, 16, 21, 17, 18, 22, 14],
      failedCounts: [13, 8, 3, 7, 4, 2, 1],
      color: '#8b5cf6'
    },
    oms: {
      name: 'OMS',
      // Feb 5-11: Passed and Failed data (Feb 7 has 1 failure, not 2)
      passedCounts: [3, 4, 4, 4, 4, 4, 2],
   ...
   overall: {
      ...
      passedCounts: [38, 27, 42, 48, 40, 48, 29],
      // Feb 5-11: Total Failed across all platforms (Feb 11: 1+3+0+0=4)
      failedCounts: [12, 29, 14, 8, 16, 5, 2],
