...
const PlatformSpecificChart: React.FC<PlatformSpecificChartProps> = ({ platform }) => {
  ...
  const platformConfigs = {
    desktop: {
      ...
      passedCounts: [14, 10, 18, 19, 15, 21, 6],
      failedCounts: [5, 14, 6, 5, 9, 2, 1],
      color: '#3b82f6'
    },
    mobile: {
      name: 'Mobile Site',
      // Feb 5-11: Passed and Failed data (Feb 11: -1 passed = 10)
      passedCounts: [16, 11, 16, 21, 17, 18, 6],
      failedCounts: [7, 13, 8, 3, 7, 4, 0],
      color: '#8b5cf6'
    },
    oms: {
      name: 'OMS',
    ...
    overall: {
      ...
      passedCounts: [35, 38, 27, 42, 48, 40, 12],
      // Feb 5-11: Total Failed across all platforms (Feb 11: 1+3+0+0=4)
      failedCounts: [14, 12, 29, 14, 8, 16, 1],
