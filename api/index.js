...
function generateMockTestResults() {
  ...
  return {
    desktop: {
      ...
      totalSteps: 131,
      modules: [
        createModule("Home Page Exploration", 11, 0, 860),
        ...
        createModule("Search Based Purchase", 4, 0, 302),
        createModule("Personalized Product with Upload 1 Photo", 5, 0, 295),
        createModule("Personalized Product with Upload 4 Photos", 6, 0, 380),
        createModule("Gmail OTP Login Journey", 5, 0, 400),
      ],
    },
    mobile: {
      total: 111,
      ...
      modules: [
        ...
        createModule("International Phone Number Change", 9, 0, 900),
        ...
        createModule("Same SKU Delivery Comparison", 7, 0, 500),
        createModule("Search, Filter & Order Completion", 7, 0, 550),
        createModule("Photo Upload Personalization", 10, 0, 600),
        createModule("Spherical Home Page Icon Exploration", 4, 0, 650),
        createModule("Location Testing", 8, 0, 650),
      ],
    },
    android: {
      total: 14,
